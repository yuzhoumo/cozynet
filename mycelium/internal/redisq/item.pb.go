...
type RedisQueueItem struct {
	...
	Retries       *int32                 `protobuf:"varint,2,req,name=retries" json:"retries,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RedisQueueItem) Reset() {
	*x = RedisQueueItem{}
...
func (x *RedisQueueItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RedisQueueItem) ProtoMessage() {}

func (x *RedisQueueItem) ProtoReflect() protoreflect.Message {
	mi := &file_item_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use ReqisQueueItem.ProtoReflect.Descriptor instead.
func (*RedisQueueItem) Descriptor() ([]byte, []int) {
	return file_item_proto_rawDescGZIP(), []int{0}
}

func (x *RedisQueueItem) GetLocation() string {
...
func (x *RedisQueueItem) GetRetries() int32 {
...
const file_item_proto_rawDesc = "" +
	...
	"\n" +
	"item.proto\"F\n" +
	"\x0eReqisQueueItem\x12\x1a\n" +
	"\blocation\x18\x01 \x02(\tR\blocation\x12\x18\n" +
	"\aretries\x18\x02 \x02(\x05R\aretriesB\x1aZ\x18mycelium/internal/redisq"
...
var file_item_proto_goTypes = []any{
	(*RedisQueueItem)(nil), // 0: ReqisQueueItem
}
